...
class HBNBCommand(cmd.Cmd):
    ...
    def emptyline(self):
        """Pass do nothing upon receiving an empty line."""
        pass
    ...
    def do_create(self, arg):
        ...
        elif args[0] not in HBNBCommand._classes_:
    ...
    def do_all(self, arg):
        ...
        args = parse_(arg)
        if len(args) > 0 and args[0] not in HBNBCommand._classes_:
            print("** class doesn't exist **")
        else:
            objs = []
    ...
    def do_update(self, arg):
       ...
       <class>.update(<id>, <dictionary>)
        ...
        if len(args) == 0:
            print("** class name missing **")
            return False
        if args[0] not in HBNBCommand._classes_:
            print("** class doesn't exist **")
            return False
        if len(args) == 1:
            print("** instance id missing **")
